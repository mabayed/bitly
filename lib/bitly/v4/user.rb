module Bitly
  module V4
    ...
    class User
      ...
      #
      # http://code.google.com/p/bitly-api/wiki/ApiDocumentation#/v4/user/referrers
      def referrers(opts={})
      ...
      #
      # http://code.google.com/p/bitly-api/wiki/ApiDocumentation#/v4/user/countries
      def countries(opts={})
      ...
      #
      # http://code.google.com/p/bitly-api/wiki/ApiDocumentation#/v4/user/realtime_links
      ...
      #
      # http://code.google.com/p/bitly-api/wiki/ApiDocumentation#/v4/user/clicks
      def clicks(opts={})
        get_clicks(opts)
        @clicks
      end
